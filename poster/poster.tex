    ...
    \begin{center}
      \begin{minipage}[c]{.95\textwidth}
        ...
        \begin{tikzpicture}
          ...
          \node[below=of effects] (figure) {
            \begin{minipage}{\textwidth}
              \begin{figure}[h]
                \centering
                \includegraphics[width=.8\textwidth]{../img/changeOfJ.pdf}
                \caption{Unidimensional example}
              \end{figure}
            \end{minipage}
          };
          \draw[line width=.5cm,red,latex-] (9,-10) -- (8,-2) node[above] {Unstable};
          \node[draw,circle,minimum width=2cm,line width=.2cm,blue] (circle) at (-7,-11) {};
          \draw[line width=.2cm,blue,latex-] (circle) -- (-1,-12) node[below] {Optimal objective};
        \end{tikzpicture}
         \\[.8ex]
