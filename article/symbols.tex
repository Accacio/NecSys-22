...
\newcommand{\uikk}{\mpcval{u}[i][k][k]}
\newcommand{\optuikk}{\mpcval*{u}[i][k][k]}
...
\newcommand{\thetaiseq}{\mpcvec{\theta}[i][k:k+\predhorz-1][k]}
...
\newcommand{\lambdaiseq}{\mpcvec{\lambda}[i][k:k+\predhorz-1][k]}
