...
\begin{abstract}% Abstract of not more than 250 words.
  ...
  This paper proposes a monitoring scheme based on Expectation Maximization to detect and mitigate the effects of attacks in a resource allocation framework.
...
\todo[Correct alignment maybe]{
  \begin{subequations}\label{eq:quadratic_case}
    \begin{align}
      ...
      \mathrm{s.t.}&&\bar{\Gamma}_{i}\Uik\preceq\vec{\theta}_{i}[k]:\vec{\lambda}_{i}[k]\label{eq:constraints}\\
                                        &&\Uik\succeq\0_{c},
    \end{align}
  \end{subequations}
}
